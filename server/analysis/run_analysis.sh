...
mongoexport --db memoire_manips --collection normalized_questions --type=csv --fields id,index,begunOn,answeredOn,answer,usedResources,instantImpact,recurringImpact,previousBalance,timeSpent,timeBeforeFirstResource,articlesRead,rawDataUsed,adviceUsed,dubiousArticlesRead,dubiousArticlesHeeded,trustedArticlesRead,trustedArticlesHeeded,heededResourceAdvice,heededAdviceAdvice,rightAnswer,stake,perceivedStake,effortBase,effortCostSalary,effortCostBonus,timeCostSalary,timeCostBonus,isLateStart,isLateEnd,isLate,requiresMath,belowStartBudget,below1000,justLostMoney,bigNumbers,user_id,userBalance,userResourceTrustIndex,userRiskAversionIndex,userGullibilityIndex,userSkillIndex,userMathSkillIndex,userFieldOfStudy,userStudyProgram,userEnglishSkills,userArticlesRead,userRawDataUsed,userAdviceUsed,userDubiousArticlesRead,userDubiousArticlesHeeded,userTrustedArticlesRead,userTrustedArticlesHeeded,userAdviceAdvicesHeeded,userTotalResourcesUsed,userMaxEffort,userMinEffort --out normalized_questions.csv
