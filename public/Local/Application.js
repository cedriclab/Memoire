...
window.Namespace.Application.prototype._init = function(context){
	this._context = context;
	this._sectionIndex = 0;
	this._sections = ["welcome", "showExplanations", "beginWarmup", "beginGame", "beginPersonal", "thankYou"];
};

window.Namespace.Application.prototype.showMessage = function(message){
	console.log(message);
},

window.Namespace.Application.prototype.showLink = function(link, context){
	this._context.resourceView = new Namespace.ResourceView({link: link, superSection : context});
	this._context.resourceView.render();
},

window.Namespace.Application.prototype.next = function(){
	this[this._sections[++(this._sectionIndex)]]();
},

window.Namespace.Application.prototype.showExplanations = function(){
...
window.Namespace.Application.prototype.beginWarmup = function(){
	var now = Date.now();
...
window.Namespace.Application.prototype.beginGame = function(){
	var now = Date.now();
...
window.Namespace.Application.prototype.beginPersonal = function(){
	var now = Date.now();
...
window.Namespace.Application.prototype.thankYou = function(){
	this._context.userModel.save(null, {
		success : function(){
...
window.Namespace.Application.prototype.loadTemplates = function(path, files, callback){
...
window.Namespace.Application.prototype.main = function(){
